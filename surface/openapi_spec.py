    ...
    return {
        ...
        "paths": {
            ...
            "/api/local-events/review/collect-events": {
                "post": {"tags": ["local-event-review"], "summary": "Collect selected REAL EVENT candidates from confirmed pages", "description": "Reads confirmed List Pages that have committed REAL EVENT selections, filters unselected listing cards before detail navigation, follows official detail links with the configured Preview transport policy, writes per-listing recognition diagnostics, and persists only selected Event candidates as confirmed. It does not change List Page decisions.", "responses": {"200": json_response(object_schema), "500": json_response(ref("ErrorResponse"), "Collection failed")}},
            },
