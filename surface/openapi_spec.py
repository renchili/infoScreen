    ...
    return {
        ...
        "paths": {
            ...
            "/api/local-events/review/listing-decision": {
                "post": {"tags": ["local-event-review"], "summary": "Save a List Page decision and optional Preview selections", "description": "A normal candidate ID updates the List Page decision. Studio uses a validated preview-review-v1: envelope to commit the complete REAL EVENT / NOT EVENT selection set and the List Page decision in one request. Confirmation requires at least one committed REAL EVENT; a rejected page cannot contain REAL EVENT selections. If the List Page state write fails, the prior Preview selection file is restored.", "requestBody": request_body(decision_schema), "responses": {"200": json_response(object_schema), "400": json_response(ref("ErrorResponse"), "Invalid decision or Preview selection payload")}},
            },
